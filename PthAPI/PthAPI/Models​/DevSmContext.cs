...
public partial class DevSmContext : DbContext
{
    public DevSmContext()
    {
    }

    public DevSmContext(DbContextOptions<DevSmContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-53K42V9;Database=DevSM;uid=sa;pwd=123456;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__ADMIN_LO__4364C8826C4387D3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Cart__3214EC07EFF019A4");
        ...
        {
            entity.HasKey(e => e.Email).HasName("PK__Login__A9D105354821775B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC274FC1D880");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC279E04F6BD");
